 ...
 * Constructor returns an actual two-element array, to allow destructing.
...
diff_match_patch.prototype.diff_bisect_ = function (text1, text2, deadline) {
  ...
  for (var d = 0; d < max_d; d++) {
    ...
    for (var k2 = -d + k2start; k2 <= d - k2end; k2 += 2) {
      var k2__offset = v_offset + k2;
      var x_2;
      if (k2 == -d || (k2 != d && v2[k2__offset - 1] < v2[k2__offset + 1])) {
        x_2 = v2[k2__offset + 1];
      } else {
        x_2 = v2[k2__offset - 1] + 1;
      }
      var y2 = x_2 - k2;
      while (
        x_2 < text1_length &&
        y2 < text2_length &&
        text1.charAt(text1_length - x_2 - 1) == text2.charAt(text2_length - y2 - 1)
      ) {
        x_2++;
        y2++;
      }
      ...
      if (x_2 > text1_length) {
        ...
        var k1__offset = v_offset + delta - k2;
        if (k1__offset >= 0 && k1__offset < v_length && v1[k1__offset] != -1) {
          var x_1 = v1[k1__offset];
          var y_1 = v_offset + x_1 - k1__offset;
          // Mirror x_2 onto top-left coordinate system.
          x_2 = text1_length - x_2;
          if (x_1 >= x_2) {
            // Overlap detected.
            return this.diff_bisectSplit_(text1, text2, x_1, y_1, deadline);
          }
        }
      }
    }
...
diff_match_patch.prototype.patch_addPadding = function (patches) {
  ...
  if (diffs.length == 0 || diffs[diffs.length - 1][0] != DIFF_EQUAL) {
    ...
    // Grow last equality.
    var extraLength2 = paddingLength - diffs[diffs.length - 1][1].length;
    diffs[diffs.length - 1][1] += nullPadding.substring(0, extraLength2);
    patch.length1 += extraLength2;
    patch.length2 += extraLength2;
  }
