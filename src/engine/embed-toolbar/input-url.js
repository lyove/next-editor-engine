...
const template = (data) => {
  return '\n  <span class="xEditor-embed-toolbar-item xEditor-embed-toolbar-item-input">\n    <input data-role="input" placeholder="'
    .concat(
      escape(data.placeholder),
      '" class="xEditor-embed-toolbar-linkinput" type="input" value="'
    )
    .concat(escape(data.url), '" />\n  </span>\n  ');
};
